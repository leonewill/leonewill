    ...
    <main class="w-full flex flex-col justify-start items-center">
      ...
      <div class="w-12/12 pt-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-40">
        ...
        <div class="w-full px-10 lg:pl-0 lg:pr-20 flex flex-col justify-center">
          ...
          <p class="text-xl text-white">
            Essa ideía foi criada por mim e mais um amigo, no intuíto de estudar novas tecnologias, tendências e conceitos de experiência do usuário com um público bem específico.
            <br><br>
            O projeto esta sendo desenvolvido bem aos ”poucos” por ser um projeto de estudo e ”for fun”!
          </p>
        </div>
      </div>
      <div class="w-full flex flex-col justify-center items-center mt-20">
        <p class="w-full lg:w-6/12 text-4xl lg:text-6xl px-4 lg:px-0 text-white text-center">E um pouco do que esta por vir do Smash 👀</p>
